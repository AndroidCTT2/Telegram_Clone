...
public class RegisterFragment extends Fragment {
    ...
    private MaterialButton btnConfirmRegister;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editConfirmPassword=view.findViewById(R.id.editConfirmPasswword);
        ...
        btnConfirmRegister.setOnClickListener(new View.OnClickListener() {
          ...
          //      navController.navigate(R.id.action_registerFragment_to_validationPhone);
            }
        });
